...
namespace CoolForecast.Api.Core
{
    ...
    public partial class MlApiClient 
    {
        private System.Net.Http.HttpClient _httpClient;
        private static System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings, true);

        public MlApiClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <summary>
        /// Predict Data From Csv
        /// </summary>
        /// <returns>Successful Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<Response> PostAsync(FileParameter file)
        {
            return PostAsync(file, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Successful Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Response> PostAsync(FileParameter file, System.Threading.CancellationToken cancellationToken)
        {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException<Message>("Bad Request", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 422)
                        {
    ...
    public partial class Body_create_upload_file_educate_model__post
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.0.0.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Body_predict_data_from_csv_predict__post
    {
        [Newtonsoft.Json.JsonProperty("file", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public byte[] File { get; set; }
    ...
    public partial class Data
    {
        ...
        [Newtonsoft.Json.JsonProperty("predict", Required = Newtonsoft.Json.Required.Always)]
